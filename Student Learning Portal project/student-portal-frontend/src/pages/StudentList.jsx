  ...
  return (
    <div className="space-y-7 py-6" style={{ color: "#dae2fd" }}>
      ...
      <section
        ...
        style={{
          background: "linear-gradient(135deg, #0f1829 0%, #111f3a 100%)",
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-500 text-sm mb-6">
            Manage students, materials, assignments and quizzes from one place.
          </p>
          {role === "TEACHER" && (
            <button
        ...
        <span
          className="material-symbols-outlined absolute right-8 bottom-2 opacity-5 text-blue-400"
          ...
          {!searched && (
            <div className="p-16 text-center" style={card}>
              ...
              <p className="text-slate-600 text-sm">
                Enter a name, email or course above
              </p>
            </div>
          )}
          ...
          {searched && students.length > 0 && (
            <div className="overflow-hidden" style={card}>
              <div
                ...
                style={{ borderBottom: "1px solid rgba(77,142,255,0.08)" }}
              >
                  ...
                  <tbody>
                    {students.map((s) => (
                      <tr
                        ...
                        onMouseEnter={(e) =>
                          (e.currentTarget.style.backgroundColor = "#0f1829")
                        }
                        onMouseLeave={(e) =>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <div
                              ...
                              style={{
                                background:
                                  "linear-gradient(135deg,#4d8eff,#1d4ed8)",
