...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      <header
        className="fixed top-0 w-full z-50 flex items-center justify-center px-6 py-4"
        style={{
          backgroundColor: "rgba(8,14,31,0.8)",
        ...
        <div className="w-full max-w-sm space-y-6">
          <div className="text-center">
            ...
            <p className="text-slate-500 text-sm mt-2">
              Join the academic portal today
            </p>
          </div>
          ...
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 8px 48px rgba(0,0,0,0.5), 0 0 80px rgba(77,142,255,0.05)",
            }}
          >
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 font-bold rounded-xl transition-all active:scale-[0.98] mt-2"
                style={{
                  background: "linear-gradient(135deg,#4d8eff,#1d4ed8)",
                  color: "#fff",
